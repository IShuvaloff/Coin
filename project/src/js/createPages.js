...
function createPageAuth() {
  ...
  // const title = createContentTitle('login');
  ...
  try {
    ...
    if (accountBlocks.length) {
      ...
      if (accountBlocks.includes('transactions-history')) {
        ...
        transactionsHistory.style.gridArea = '2 / 1 / span 1 / span 2'; // ! начало на 2 строке, 1 столбце, растяжение на 1 строку, 2 столбца
